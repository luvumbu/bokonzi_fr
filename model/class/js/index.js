...
var informaation_addlogin = new Information("addlogin.php"); // création de la classe 

informaation_addlogin.add("prenom", prenom); // ajout de l'information pour lenvoi 

informaation_addlogin.add("nom", nom); // ajout de l'information pour lenvoi 

informaation_addlogin.add("mobile_mail", mobile_mail); // ajout de l'information pour lenvoi 

informaation_addlogin.add("password", password); // ajout de l'information pour lenvoi 

informaation_addlogin.add("naissance", naissance); // ajout de l'information pour lenvoi 
informaation_addlogin.add("sex", sex); // ajout de l'information pour lenvoi 



console.log(informaation_addlogin.info()); // demande l'information dans le tableau
informaation_addlogin.push(); // envoie l'information au code pkp 
