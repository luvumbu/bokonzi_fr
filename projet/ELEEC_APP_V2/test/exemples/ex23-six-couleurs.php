...
<head>
    <meta charset="UTF-8">
    <title>Exemple 23 - Mur Mario (6 couleurs)</title>
    <link rel="stylesheet" href="../../css/style.css">
</head>
<body>
    <div id="titre" style="position:fixed;top:10px;left:10px;background:rgba(0,0,0,0.7);color:#fff;padding:10px;border-radius:6px;font-family:monospace;font-size:14px;z-index:10;">Exemple 23 — Mur Mario (6 couleurs)</div>
    ...
    mur_6.setPriorite(6);
    mur_6.construire(0, 0, 0, 5, 2.50, 0);
