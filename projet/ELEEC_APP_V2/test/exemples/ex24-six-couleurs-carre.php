...
<head>
    <meta charset="UTF-8">
    <title>Exemple 24 - Carre Mario (6 couleurs x 4 murs)</title>
    <link rel="stylesheet" href="../../css/style.css">
</head>
<body>
    <div id="titre" style="position:fixed;top:10px;left:10px;background:rgba(0,0,0,0.7);color:#fff;padding:10px;border-radius:6px;font-family:monospace;font-size:14px;z-index:10;">Exemple 24 — Carre Mario (6 couleurs x 4 murs)</div>
    ...
    mur_1.setPriorite(1);
    mur_1.construireForme(0, 0, 0, 5, 2.50, 4, 0);
    ...
    mur_2.setPriorite(2);
    mur_2.construireForme(0, 0, 0, 5, 2.50, 4, 0);
    ...
    mur_3.setPriorite(3);
    mur_3.construireForme(0, 0, 0, 5, 2.50, 4, 0);
    ...
    mur_4.setPriorite(4);
    mur_4.construireForme(0, 0, 0, 5, 2.50, 4, 0);
    ...
    mur_5.setPriorite(5);
    mur_5.construireForme(0, 0, 0, 5, 2.50, 4, 0);
    ...
    mur_6.setPriorite(6);
    mur_6.construireForme(0, 0, 0, 5, 2.50, 4, 0);
