...
<head>
    <meta charset="UTF-8">
    <title>Exemple 4 - Forme N cotes</title>
    <link rel="stylesheet" href="../../css/style.css">
</head>
<body>
    <div id="titre" style="position:fixed;top:10px;left:10px;background:rgba(0,0,0,0.7);color:#fff;padding:10px;border-radius:6px;font-family:monospace;font-size:14px;z-index:10;">Exemple 4 — Forme N cotes (1, 2, 3 murs)</div>
    ...
    mur1.construireForme(0, 0, 0, 3, 1.50, 1, 0);
    var mur2 = new Brique(sceneManager.scene);
    mur2.construireForme(5, 0, 0, 3, 1.50, 2, 0);
    var mur3 = new Brique(sceneManager.scene);
    mur3.construireForme(10, 0, 0, 3, 1.50, 3, 0);
