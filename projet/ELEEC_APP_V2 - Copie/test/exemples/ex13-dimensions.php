...
<head>
    <meta charset="UTF-8">
    <title>Exemple 13 - Dimensions personnalisees</title>
    <link rel="stylesheet" href="../../css/style.css">
</head>
<body>
    <div id="titre" style="position:fixed;top:10px;left:10px;background:rgba(0,0,0,0.7);color:#fff;padding:10px;border-radius:6px;font-family:monospace;font-size:14px;z-index:10;">Exemple 13 — Dimensions personnalisees</div>
    ...
    mur.setDimensions(0.30, 0.10, 0.15);
    mur.setJoint(0.02);
